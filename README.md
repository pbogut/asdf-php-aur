...
It builds php versions form AUR repository, and allows you to use them with `asdf`.
...
It installs selected php version from `AUR` using `makepkg` and `pacman`, and then creates symlinks for `asdf` to use. 
